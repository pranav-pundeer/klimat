...
// TODO: build this page like the home page and then divert from search screen onto here

class SearchedCity extends StatefulWidget {
  SearchedCity(this.currentWeather, this.weekForecastData, this.city);
...
class _SearchedCityState extends State<SearchedCity> {
  ...
  Future<void> _pullRefresh() async {
    ...
    var currentWeatherData = await currentWeather.getCityWeather(widget.city);
